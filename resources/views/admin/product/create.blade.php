                    ...
                    <form action="{{ route('admin.product.store') }}" method="POST" class="space-y-4" enctype="multipart/form-data">
                        ...
                        <div class="grid grid-cols-1 gap-4">
                            ...
                            <div>
                                ...
                                <input id="price" type="number" name="price" class="w-full border-gray-300 rounded-md" value="{{ old('price') }}" required min="0">
                            ...
                            <div>
                                <img src="{{ asset('images/default-image.jpg') }}" alt="default-image" class="img-thumbnail img-preview" width="300">
